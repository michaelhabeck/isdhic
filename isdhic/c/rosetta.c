...
static double energy(PyRosettaObject *self, PyUniverseObject *universe, int *types) {
  return forcefield_energy((PyForceFieldObject*)self, universe, types);
}

static int gradient(PyRosettaObject *self, PyUniverseObject *universe, int *types, double *E_ptr) {
